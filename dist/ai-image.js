...
exports.AIImageService = exports.IMAGE_PRESETS = void 0;
...
class AIImageService {
    ...
    async generateImage(request) {
        try {
            const preset = request.presetId
                ? exports.IMAGE_PRESETS.find(p => p.id === request.presetId)
                : exports.IMAGE_PRESETS.find(p => p.id === 'custom');
            // Build the full prompt
            let fullPrompt = request.prompt;
            if (preset && preset.id !== 'custom') {
                fullPrompt = preset.promptTemplate.replace('{description}', request.prompt);
            }
            const negativePrompt = (preset === null || preset === void 0 ? void 0 : preset.negativePrompt) || 'blurry, low quality, text, watermark';
     ...
     */
    callSeedreamAPI(prompt, negativePrompt, referenceImage) {
     ...
     */
    async importToProject(filePath, importPath) {
