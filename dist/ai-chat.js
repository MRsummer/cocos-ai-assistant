...
exports.AIChatEngine = void 0;
const https = __importStar(require("https"));
const http = __importStar(require("http"));
const cocos_reference_1 = require("./cocos-reference");
/**
...
${cocos_reference_1.COCOS_REFERENCE}`;
    }
    /**
     ...
     */
    async chat(userMessage, onStatus) {
        const session = this.getCurrentSession();
        if (!session) {
        ...
        onStatus === null || onStatus === void 0 ? void 0 : onStatus({ type: 'thinking', message: '正在收集工程上下文...' });
        try {
        ...
        while (maxIterations > 0) {
            maxIterations--;
            onStatus === null || onStatus === void 0 ? void 0 : onStatus({ type: 'thinking', message: 'AI 正在思考...' });
            let response;
            try {
                ...
                onStatus === null || onStatus === void 0 ? void 0 : onStatus({ type: 'error', message: errMsg });
                return errMsg;
            }
            ...
            for (const block of textBlocks) {
                if (block.text) {
                    ...
                    onStatus === null || onStatus === void 0 ? void 0 : onStatus({ type: 'text', message: block.text });
                }
            }
            // If no tool calls, we're done
            if (toolUseBlocks.length === 0 || response.stop_reason === 'end_turn') {
                if (toolUseBlocks.length === 0) {
                    onStatus === null || onStatus === void 0 ? void 0 : onStatus({ type: 'done', message: '完成' });
                    break;
                }
            }
            // Execute tool calls
        ...
        if (maxIterations <= 0) {
            ...
            onStatus === null || onStatus === void 0 ? void 0 : onStatus({ type: 'error', message: msg });
            finalText += '\n' + msg;
        }
    ...
    callAnthropicAPI(messages, tools) {
...
exports.AIChatEngine = AIChatEngine;
