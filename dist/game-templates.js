...
exports.GameTemplateService = exports.GAME_TEMPLATES = void 0;
/**
 * Built-in game templates
 */
exports.GAME_TEMPLATES = [
    {
        id: 'platformer-2d',
        name: '2D 横版跑酷',
...
class GameTemplateService {
     ...
     */
    getTemplates() {
        return exports.GAME_TEMPLATES;
    }
    /**
     * Get template by ID
     */
    getTemplate(id) {
        return exports.GAME_TEMPLATES.find(t => t.id === id) || null;
    }
    /**
     * Get templates by category
     */
    getTemplatesByCategory(category) {
        return exports.GAME_TEMPLATES.filter(t => t.category === category);
    }
    /**
